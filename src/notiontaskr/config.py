...
LOCAL_SCHEDULED_PICKLE_PATH = os.path.join(CACHE_DIR, 'scheduled_task.pkl')  # ローカルのpickleファイルの保存先
BUCKET_SCHEDULED_PICKLE_PATH = '/notion-api/cache/scheduled_task.pkl'  # GCSのpickleファイルの保存先
