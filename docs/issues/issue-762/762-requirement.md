...
- [7. タスクの名前に関するルールの追加](#7-タスクの名前に関するルールの追加)
  - [7.1. 現在のルール](#71-現在のルール)
  - [7.2. 追加ルール](#72-追加ルール)
- [8. クラス設計](#8-クラス設計)
  - [8.1. `Remind`クラス(新規)](#81-remindクラス新規)
  - [8.2. `Task`クラス(既存)の拡張](#82-taskクラス既存の拡張)
  - [8.3. `TaskReminder`クラス(新規)](#83-taskreminderクラス新規)
  - [8.4. `Notifier`インターフェース(新規)](#84-notifierインターフェース新規)
  - [8.5. `SlackNotifier(Notifier)`クラス(新規)](#85-slacknotifiernotifierクラス新規)
  - [8.6. `SlackAPIHandler`クラス(新規)](#86-slackapihandlerクラス新規)
  - [8.8. `TimeUtil`クラス(新規)](#88-timeutilクラス新規)
- [9. UML](#9-uml)
  - [9.1. シーケンス図](#91-シーケンス図)
  - [9.2. クラス図](#92-クラス図)
- [10. タスク](#10-タスク)
